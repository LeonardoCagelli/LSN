...
private:
  ...
  bool _save_averages = false;

  std::string _input_path = "../INPUT/";      // input path 
  std::string _output_path = "../OUTPUT/";    // output path
  std::string _temperature_path = "temperature.dat";
...
public: // Function declarations
  ...
  //bool gibbs(int part);       // Perform Gibbs acceptance-rejection step
  ...
  // my function
  void print_AVG();
  void write_averages(const std::string& path); // function to save averages
  void setInputPath(const std::string& path);     // set the input path
  void setOutputPath(const std::string& path);    // set the output path 
  void printPath();           // print to the terminal the input and the output path 
  void SetTemperature(double temp);       // set the temperature to a desired value
  void setEquilibriumTemp(const std::string& path);       // function to read the temperature from an output file 
  void setTemperaturePath(const std::string& path);
