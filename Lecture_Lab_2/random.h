...
public:
  ...
  // Method to generate a random number with a Lorentizan distribution
  double Lorentz(double lambda, double x0);
  // Function to generate points according to any distribution
  double GenerateDistribution(const std::function<double(double)> &g, double a, double b, double g_max);
